...
void loop () {
    ...
    leituraA0 = analogRead(pinoPOT); //LÊ O VALOR NO PINO ANALÓGICO (VALOR LIDO EM BITS QUE VAI DE 0 A 1023)
     luminosidadeLED = map(leituraA0, 0, 1023, 0, 255); //EXECUTA A FUNÇÃO "map" DE ACORDO COM OS PARÂMETROS PASSADOS
     analogWrite(pinoRele, luminosidadeLED); //APLICA AO LED O VALOR DE LUMINOSIDADE (PWM) GERADO PELA FUNÇÃO "map"
